class NodeGraph:
    __slots__ = ["name", "coveredDistance", "remainingBudget", "remainingTime", "visitedNodes"]

    def __init__(
        self, name: str, coveredDistance: int, remainingBudget: int, remainingTime: int, visitedNodes: list[str]
    ):
        self.name = name
